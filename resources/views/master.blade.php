                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                @foreach ($status as $sta)
                                    <a class="dropdown-item"
                                        href="{{ route('danhmuc', $sta->id) }}">{{ $sta->name }}</a>
                    ...
                    <ul class="navbar-nav ml-auto">
                        @if (Route::has('login'))
                            @auth
                                ...
                                @endif
                                <li class="nav-item">
                                    <a href="gettheodoi" class="nav-link"><i class="fa fa-book"
                                            aria-hidden="true"></i> Tủ truyện</a>
                                </li>
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button"
                                        data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        {{-- <li class="nav-item">--}}
                            ...
                            {{-- </li>--}}
                        {{-- <li class="nav-item">--}}
                            {{-- <a href="account.html" class="nav-link">Tên
                                User</a>--}}
                            {{-- </li>--}}
                        {{-- <li class="nav-item">--}}
                            {{-- <a class="nav-link" href="/dangnhap">Đăng
                                Nhập</a>--}}
                            {{-- </li>--}}
                        {{-- <li class="nav-item ">--}}
                            {{-- <a class="nav-link" href="/dangky">Đăng
                                Ký</a>--}}
                            {{-- </li>--}}
                    </ul>
                </div>
